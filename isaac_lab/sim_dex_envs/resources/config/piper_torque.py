...
PIPER_TORQUE_CFG = ArticulationCfg(
    ...
    actuators={ 
        ...
        "joints1234": ImplicitActuatorCfg(
            joint_names_expr=["joint[1-4]"],
            stiffness=0.0,
            damping=5, # TODO: technically, should be zero for pure torque control
            effort_limit_sim=10.0,
            velocity_limit=10.0,
        ),
        "arm_joints56": ImplicitActuatorCfg(
            joint_names_expr=["joint[5-6]"],
            stiffness=0.0,
            damping=1.5, # TODO: technically, should be zero for pure torque control
            effort_limit_sim=10.0,
            velocity_limit=10.0,
        ),
        "hand": ImplicitActuatorCfg(
            ...
            velocity_limit=0.01,
            stiffness=0.0,
            damping=5.0, # TODO: technically, should be zero for pure torque control
        ),
    },
